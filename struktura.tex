...
Drugie z~wymienionych zagadnień w~znacznej mierze zależne jest
od~struktury układu równań. Omówienie go wymaga wcześniejszej znajomości
nie~tylko metodyki jego~tworzenia, ale~również postaci równań w~nim
występujących. Dlatego~też omówione zostanie
w~rozdziale~\ref{rozw-ukl-rown}. W~tym rozdziale natomiast rozpatrzony
zostanie~sposób tworzenia układu równań.
